 ...
 */
@Component
public class BackOfficeRealm extends AuthorizingRealm {

	@Autowired
    protected UserDao userDao = null;

    public BackOfficeRealm() {
        setName("BackOfficeRealm"); //This name must match the name in the User class's getPrincipals() method
